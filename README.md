...
- **Game:** select a tower and click any clear ground, including the shaded spawn zone. Wall and barbed-wire tools show their snapped footprint before placement; cyan is buildable and red marks a blocked, unaffordable, or route-closing cell. Walls still cannot hold towers. Select the same build button again or press Escape to leave placement mode. Use **Demolish** (or press **R**) on player-built walls or wire to recover half their Metal cost. Click a deployed tower to inspect, upgrade, or sell it. Start the wave when ready.
