  ...
  return {
    ...
    update(s: UIState) {
      ...
      if (s.selected && chosen) {
        const t = s.selected,
          d = compileTower(t, [], s.commandUpgrades),
      ...
      root.querySelector<HTMLButtonElement>('[data-action="step"]')!.disabled =
        !s.paused;
