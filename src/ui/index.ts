...
export function createUI(
  ...
  return {
    ...
    update(s: UIState) {
      ...
      $('#battlefield-help').textContent=s.dam?'Three spillways · switchable gates · flood surge':'Campaign · '+(s.mapTitle??'Pine Valley');
