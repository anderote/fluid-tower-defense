...
/* Recycle hover branch variant is superseded here by the placement-preview wall model. */
 ...
 handleAction=action=>{
   ...
   switch(action.type){
     ...
     case 'wall-tool':wallTool=!wallTool;wireTool=false;state.selectedKind=null;state.message=wallTool?'Wall tool: click to place a 4 × 4 Metal wall, or reinforce a damaged wall to full integrity.':'Wall tool cancelled.';break;
